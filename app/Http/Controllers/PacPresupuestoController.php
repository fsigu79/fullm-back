...
class PacPresupuestoController extends Controller
{
    ...
    private $sqlcompara="select t1.ctamaecon,nomcta,
                            ctacontpre,anopre,
                            ...
                            (select ifnull(sum(if(SUBSTR(t1.ctamaecon,1,1)='4',if(db1cr2his='2',valorhis,valorhis*-1),if(db1cr2his='2',valorhis*-1,valorhis))),0)
                             FROM movcon
                             WHERE ctahiscon=t1.ctamaecon and MONTH(fechahis)=1 and year(fechahis)='yanioa' AND dethis  NOT LIKE 'CIERRE DE EJERCICIO%'
                            ) as valpre0,
                            ...
                            (select ifnull(sum(if(SUBSTR(t1.ctamaecon,1,1)='4',if(db1cr2his='2',valorhis,valorhis*-1),if(db1cr2his='2',valorhis*-1,valorhis))),0)
                             FROM movcon
                             WHERE ctahiscon=t1.ctamaecon and MONTH(fechahis)=2 and year(fechahis)='yanioa'
                            ) as valpre1,
                            ...
                            (select ifnull(sum(if(SUBSTR(t1.ctamaecon,1,1)='4',if(db1cr2his='2',valorhis,valorhis*-1),if(db1cr2his='2',valorhis*-1,valorhis))),0)
                             ...
                             (select ifnull(sum(if(SUBSTR(t1.ctamaecon,1,1)='4',if(db1cr2his='2',valorhis,valorhis*-1),if(db1cr2his='2',valorhis*-1,valorhis))),0)
                             FROM movcon
                             WHERE ctahiscon=t1.ctamaecon and MONTH(fechahis)=3 and year(fechahis)='yanioa') as valpre2,
                            ...
                            (select ifnull(sum(if(SUBSTR(t1.ctamaecon,1,1)='4',if(db1cr2his='2',valorhis,valorhis*-1),if(db1cr2his='2',valorhis*-1,valorhis))),0)
                             ...
                             (select ifnull(sum(if(SUBSTR(t1.ctamaecon,1,1)='4',if(db1cr2his='2',valorhis,valorhis*-1),if(db1cr2his='2',valorhis*-1,valorhis))),0)
                             FROM movcon
                             WHERE ctahiscon=t1.ctamaecon and MONTH(fechahis)=4 and year(fechahis)='yanioa') as valpre3,
                            ...
                            (select ifnull(sum(if(SUBSTR(t1.ctamaecon,1,1)='4',if(db1cr2his='2',valorhis,valorhis*-1),if(db1cr2his='2',valorhis*-1,valorhis))),0)
                             ...
                             (select ifnull(sum(if(SUBSTR(t1.ctamaecon,1,1)='4',if(db1cr2his='2',valorhis,valorhis*-1),if(db1cr2his='2',valorhis*-1,valorhis))),0)
                             FROM movcon
                             WHERE ctahiscon=t1.ctamaecon and MONTH(fechahis)=5 and year(fechahis)='yanioa') as valpre4,
                            ...
                            (select ifnull(sum(if(SUBSTR(t1.ctamaecon,1,1)='4',if(db1cr2his='2',valorhis,valorhis*-1),if(db1cr2his='2',valorhis*-1,valorhis))),0)
                             FROM movcon
                             WHERE ctahiscon=t1.ctamaecon and MONTH(fechahis)=6 and year(fechahis)='yanioa') as valpre5,
                            ...
                            (select ifnull(sum(if(SUBSTR(t1.ctamaecon,1,1)='4',if(db1cr2his='2',valorhis,valorhis*-1),if(db1cr2his='2',valorhis*-1,valorhis))),0)
                             FROM movcon
                             WHERE ctahiscon=t1.ctamaecon and MONTH(fechahis)=7 and year(fechahis)='yanioa') as valpre6,
                            ...
                            (select ifnull(sum(if(SUBSTR(t1.ctamaecon,1,1)='4',if(db1cr2his='2',valorhis,valorhis*-1),if(db1cr2his='2',valorhis*-1,valorhis))),0)
                             ...
                             (select ifnull(sum(if(SUBSTR(t1.ctamaecon,1,1)='4',if(db1cr2his='2',valorhis,valorhis*-1),if(db1cr2his='2',valorhis*-1,valorhis))),0)
                             FROM movcon
                             WHERE ctahiscon=t1.ctamaecon and MONTH(fechahis)=8 and year(fechahis)='yanioa') as valpre7,
                            ...
                            (select ifnull(sum(if(SUBSTR(t1.ctamaecon,1,1)='4',if(db1cr2his='2',valorhis,valorhis*-1),if(db1cr2his='2',valorhis*-1,valorhis))),0)
                             ...
                             (select ifnull(sum(if(SUBSTR(t1.ctamaecon,1,1)='4',if(db1cr2his='2',valorhis,valorhis*-1),if(db1cr2his='2',valorhis*-1,valorhis))),0)
                             FROM movcon
                             WHERE ctahiscon=t1.ctamaecon and MONTH(fechahis)=9 and year(fechahis)='yanioa') as valpre8,
                            ...
                            (select ifnull(sum(if(SUBSTR(t1.ctamaecon,1,1)='4',if(db1cr2his='2',valorhis,valorhis*-1),if(db1cr2his='2',valorhis*-1,valorhis))),0)
                             ...
                             (select ifnull(sum(if(SUBSTR(t1.ctamaecon,1,1)='4',if(db1cr2his='2',valorhis,valorhis*-1),if(db1cr2his='2',valorhis*-1,valorhis))),0)
                             FROM movcon
                             WHERE ctahiscon=t1.ctamaecon and MONTH(fechahis)=10 and year(fechahis)='yanioa') as valpre9,
                            ...
                            (select ifnull(sum(if(SUBSTR(t1.ctamaecon,1,1)='4',if(db1cr2his='2',valorhis,valorhis*-1),if(db1cr2his='2',valorhis*-1,valorhis))),0)
                             ...
                             (select ifnull(sum(if(SUBSTR(t1.ctamaecon,1,1)='4',if(db1cr2his='2',valorhis,valorhis*-1),if(db1cr2his='2',valorhis*-1,valorhis))),0)
                             FROM movcon
                             WHERE ctahiscon=t1.ctamaecon and MONTH(fechahis)=11 and year(fechahis)='yanioa') as valpre10,
                            ...
                            (select ifnull(sum(if(SUBSTR(t1.ctamaecon,1,1)='4',if(db1cr2his='2',valorhis,valorhis*-1),if(db1cr2his='2',valorhis*-1,valorhis))),0)
                             FROM movcon
                             WHERE ctahiscon=t1.ctamaecon and MONTH(fechahis)=12 and year(fechahis)='yanioa') as valpre11,
