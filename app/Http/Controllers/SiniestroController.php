        ...
        if (!$validation->fails()) {
                try{
                    ...
                    if ($input['accion']!='Eliminar') {
                        ...
                        $resAudi=$audi->Create('Inventarios', 'Siniestros','SI',
                                        $input['serie'],
                                        $input['numero'],
                        ...
                        $audi=new AuditoriaController();
                        $resAudi=$audi->Create('Inventarios', 'Siniestros','SI',$input['serie'],$input['numero'], 'SI'.$input['serie'].'-'.str_pad($input['numero'], 9, "0", STR_PAD_LEFT),
                                                new DateTime(),
                                                $input['accion'],
                                                $input['total'] ,
                                                $input['fecha'],
