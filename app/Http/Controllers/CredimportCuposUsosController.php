...
class CredimportCuposUsosController extends Controller
{
    ...
    private $sqlgen=" SELECT codcte01 as codigo,
                            ...
                            cascte01  as ruc,
                            vendcte01 AS vencod,
  					        (SELECT nomtab FROM vintipart.maetab WHERE numtab='73' AND codtab =vendcte01) AS vendedor,
    ...
    public function cuposUsos(Request $request)
    {
        ...
        try{
            $sql=$this->generaQuery('vintipart',$inicio,$fin,$vendedor);
