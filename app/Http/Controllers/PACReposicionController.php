...
class PACReposicionController extends Controller
{
    ...
    private $sqlgen="SELECT ALL
                            ...
                            (SELECT DISTINCT reposicion FROM jcev.maepro mp1 WHERE mp1.codprod01=ybase1.maepro.codprod01) AS reposicion,
	                        marca01 AS marcod,
    ...
    private $sqlgennc="SELECT IFNULL(codprod01,'-') AS codigo,
                                ...
                                (SELECT DISTINCT reposicion FROM jcev.maepro mp1 WHERE mp1.codprod01=xbase.maepro.codprod01) AS reposicion,
						        marca01 AS marcod,
						        (SELECT DISTINCT nomtab FROM jcev.maetab WHERE numtab = '4530' AND codtab <> '' AND codtab = marca01) AS marca,
						        catcte01 AS catcod,
						        (SELECT a.desccate AS categoria FROM jcev.categorias a INNER JOIN  jcev.categorias b ON a.codcatep=b.codcate AND b.tipocate='03' WHERE a.tipocate='03' AND a.codcate=catcte01) AS cate
